...
Wow, we went over a lot. Hopefully you understand by the end of this opinionated guide how to set-up Python, Jupyter, `pip`, and `virtualenv` for your system. You should feel confident and ready to start programming in Python! Check out my `setup_python.sh` script to see how set-up my Python script at home.
